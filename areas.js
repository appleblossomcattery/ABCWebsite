...
const AREAS = [
...

  {
    ...
    journey: [
      'From Llandaff, Radyr, Fairwater, Ely or Pentyrch, the A4119 or the M4 both bring you to Junction 34 in about twenty minutes. From Canton, Cathays, Roath and the centre, allow twenty-five to thirty. From the eastern side — Rumney, St Mellons, Llanrumney — the M4 makes it a straightforward half-hour.',
